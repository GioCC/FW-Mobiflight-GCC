...
void handlerOnButton(byte eventId, uint8_t pin, const char *); //String name);
void handlerOnEncoder(byte eventId, uint8_t pin, const char *); //String name);
